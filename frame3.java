...
class Frame3 extends Frame
{
	...
	Label l7=new Label("NOTE:Enter marks out of 20");
	...
	Frame3()
	{
		...
		ch1.add("T2");ch1.add("T1");ch1.add("T3");
		mb.add(m1);
		mb.add(m2);
		mb.add(m3);
		m1.add(m11);
	...
	void b1_Click()
	{
		...
		PreparedStatement stmt=con.prepareStatement("Insert into t2 values('"+s1+"','"+s2+"',"+p1+","+p2+","+p3+","+p4+","+p5+")");
		stmt.executeUpdate();
